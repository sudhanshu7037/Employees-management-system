    ...
    <div className='flex h-screen w-screen items-center justify-center'>
        <div className='border-2 rounded-xl border-red-600 p-20'>
            ...
            >
                ...
                <button className='mt-7 text-white border-none outline-none hover:bg-red-700 font-semibold bg-red-600 text-lg py-2 px-8 w-full rounded-full placeholder:text-white'>Log in</button>
            </form>
        </div>
    </div>
  )
